class Assets {
 ...
 // static String profilePic = '$imagePath/profile_pic.png';
  static String profilePic = '$imagePath/icon-avatar.png';
  ...
  static String seaFood = '$imagePath/sea_food.png';
  static String fastFood = '$imagePath/fast_food.png';
  static String fruits = '$imagePath/fruits.png';
  static String jollofRice = '$imagePath/jollof_rice.png';
  static String salad = '$imagePath/salad.png';
  static String pizza2 = '$imagePath/pizza2.png';

  static String veggiePizza = '$imagePath/veggie_pizza.png';
  static String cheezePizza = '$imagePath/cheeze_pizza.png';
  static String meatPizza = '$imagePath/meat_pizza.png';
  static String pepperoniPizza = '$imagePath/pepperoni_pizza.png';

  static String cake2 = '$imagePath/cake2.png';
  static String iceCream = '$imagePath/ice_cream.png';
  static String iceCream1 = '$imagePath/ice_cream1.png';
